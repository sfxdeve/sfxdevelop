...
export const siteMeta: SiteMeta = {
  siteName: "SFX Develops",
  defaultTitle: "Shayan Fareed | Full Stack JavaScript Developer",
  defaultDescription:
    "Portfolio of Shayan Fareed, a production-focused Full Stack JavaScript Developer building scalable web applications.",
};
